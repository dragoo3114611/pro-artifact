...
- **Mijoz ekrani** (Zal › «Mijoz ekrani») — `klient.html` (DUST2 Klient) shu oynada ochiladi va Klub Pult bilan jonli bogʻlanadi: tanlangan PC holati (qulf ekrani sozlamalari va mavzusi, seans, qolgan vaqt, tarif, pauza, oʻchiq / qayta yuklanish, xabarlar) har soniyada klientga yuboriladi; klientdan akkaunt bilan kirish, «Vaqt soʻrash», akkauntdan chiqish va xabar oʻqilgani Klub Pult'ga qaytadi. `klient.html` yuklanmasa, ichki soddalashtirilgan ekran koʻrsatiladi.
- **`klient.html` alohida ochilsa** — mustaqil prototip: oʻngdagi panel admin buyruqlarini simulyatsiya qiladi (seans, Qayta yuklash / Oʻchirish / Yoqish, 5 va 1 daqiqa ogohlantirish, xabar, soat sinxronizatsiyasi, qulf ekrani, mavzu).
